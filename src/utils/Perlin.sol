...
/// @author https://github.com/nalinbhardwaj/exgrasia/blob/900db6cf6d6ae115361094672c21d489ac493488/eth/contracts/Perlin.sol
library Perlin {
    ...
    function getGradientAt(uint32 x, uint32 y, uint32 scale, uint32 seed)
        public
        pure
    ...
    function getWeight(uint32 cornerX, uint32 cornerY, uint32 x, uint32 y, uint32 scale)
        public
        pure
        returns (uint64)
    {
    ...
    function getCorners(uint32 x, uint32 y, uint32 scale)
        public
        pure
        returns (uint32[2][4] memory)
    {
    ...
    function getSingleScalePerlin(uint32 x, uint32 y, uint32 scale, uint32 seed)
        public
        pure
        returns (int128)
    {
    ...
    function computePerlin(uint32 x, uint32 y, uint32 seed, uint32 scale)
        public
        pure
        returns (uint256)
    {
